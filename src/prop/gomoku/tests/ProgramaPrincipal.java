...
public class ProgramaPrincipal
{
	...
	private static ControladorPartidaEnJoc controlador_partida;
	...
	public static void main( String[] args )
	{
		...
		switch ( color_fitxes )
		{
			case 1:
				...
				partida = new PartidaGomoku( jugador, oponent, new TaulerGomoku(), nom_partida );
				break;

			case 2:
				System.out.println( "\nHa seleccionat jugar amb fitxes blanques." );
				partida = new PartidaGomoku( oponent, jugador, new TaulerGomoku(), nom_partida );
				break;
		...
		controlador_partida = new ControladorPartidaEnJoc( partida );
		...
		while ( estat_partida == EstatPartida.NO_FINALITZADA )
		{
			...
			{
				System.out.println( excepcio.getMessage() + ".\nSi us plau " + jugador_actual.getNom() + ", torni a "
