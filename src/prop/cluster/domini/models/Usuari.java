 ...
 * diferents nivells de dificultat. Cada usuari té un nom com a identificador.
 */
...
public class Usuari implements Serializable
{
	...
	public String toString()
	{
		return "[Nom: " + nom + ", contrasenya: " + contrasenya + ", num victories: ["
				+ this.obteStringDeVector( num_victories ) + "], num empats: [" + this.obteStringDeVector( num_empats )
