...
public abstract class Partida implements Serializable
{
	...
	public String toString() {
		String text = "[nom: " + this.nom +
				", jugador A: " + this.jugador_a.getNom() +
				", jugador B: " + this.jugador_b.getNom() +
				", mida tauler: " + this.tauler.getMida() +
				", data creació: " + this.data_creacio.toString() +
				", finalitzada: " + this.finalitzada;
		return text;
	}
}